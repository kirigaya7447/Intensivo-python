...
grafico = pe.bar(df_analise_saldo, x="Resultado:", y="Variação (R$):", text="Variação (R$):", title="Variação X Resultado", color="Variação (R$):")
grafico.show()
...
coluna_idade = pd.DataFrame([["Empresas com mais de 100 anos", mais_de_cem], ["Empresas com menos de 50 anos", menos_de_cinquenta], ["Empresas entre os 50 e 100 anos", entre]], columns=["Intervalo","Quantidade"])

#configura e formata o grafico
grafico_idade = pe.bar(coluna_idade, y="Quantidade", x="Intervalo", title="Quantidade X Idade de empresas", color="Intervalo")
grafico_idade.show()