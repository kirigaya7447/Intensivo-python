...
coluna_idade = pd.DataFrame([["Empresas com mais de 100 anos", mais_de_cem], ["Empresas com menos de 50 anos", menos_de_cinquenta], ["Empresas entre os 50 e 100 anos", entre]], columns=["Intervalo","Idade"])
#configura e formata o grafico
grafico_idade = pe.bar(coluna_idade, y="Idade", x="Intervalo", title="Idade de empresas")
grafico_idade.show()